...
set(unique1 "?|mi01w6vJ7EVJbt6|?")
set(unique2 "?|MWY19CiFAOnbMMo|?")
...
string(REPLACE "[" unique1 file_content "${file_content}")
string(REPLACE "]" unique2 file_content "${file_content}")
...
foreach (line IN LISTS _my_list)
  ...
  string(REPLACE unique1 "[" line "${line}")
  string(REPLACE unique2 "]" line "${line}")
  message("_my_list has '${line}'")

endforeach()

function(my_function)
  #set(local_var "Function-local variable" PARENT_SCOPE)
  set(local_var "Function-local variable")
    message("Inside function: ${local_var}")  # This will print "Function-local variable"
endfunction()

my_function()  # Call the function
message("Outside function: ${local_var}")  # This will print an empty string or "Outside function: Function-local variable" depending on where it's called
