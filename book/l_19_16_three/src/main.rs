...
impl Wizard for Human {
    ...
    //}
    fn new() -> Self{
        Human { one:3, id:String::from("wizard human") }
    }
}
impl Pilot for Human {
    fn new() -> Self{
        Human { one:2, id:String::from("pilot human") }
    }
}

impl Human {
    fn new() -> Self{
        Human { one:1, id:String::from("normal human") }
    }
}

impl Pilot_i32 for Human {
    fn new(typ: i32) -> Self {
        Human { one: typ, id:String::from("pilot_i32") }
    }
}
...
impl Pilot_u8 for Human {
    fn new(typ: u8) -> Self {
        ...
        Human { one: i32::from(typ), id:String::from("pilot_u8") } //suggested by clippy
    }
}
