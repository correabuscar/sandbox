...
//        .set_dependencies(true);
    ...
    opts.set_dependencies(true);//FIXME: thread 'main' panicked at 'Failed to acquire build-time information: Os { code: 2, kind: NotFound, message: "No such file or directory" }', libcore/result.rs:945:5
