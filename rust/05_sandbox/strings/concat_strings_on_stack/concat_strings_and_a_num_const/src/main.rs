//concat strings and constant at runtime, on stack tho!
...
impl<const SIZE: usize> NoAllocFixedLenMessageOfPreallocatedSize<SIZE> {
    pub fn get_message(buffer: &mut [u8]) -> usize {
        let mut len = 0;
...
fn size_to_str(size: usize, buffer: &mut [u8]) -> usize {
...
fn main() {
    ...
    //let message_44 = NoAllocFixedLenMessageOfPreallocatedSize::<44>::get_message();
