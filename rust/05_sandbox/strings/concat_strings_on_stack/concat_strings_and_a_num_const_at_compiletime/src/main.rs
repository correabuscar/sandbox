...
impl<const SIZE: usize> NoAllocFixedLenMessageOfPreallocatedSize<SIZE> {
    pub const fn get_err_message() -> ErrMessage<{ err_msg_buffer_size() }> {
        let mut buffer = [0u8; err_msg_buffer_size()];
        let mut len = 0;
...
use some_mod::err_msg_buffer_size;
...
fn foo() {
    //const MSG_44: ErrMessage<{ NoAllocFixedLenMessageOfPreallocatedSize::<0>::err_msg_buffer_size()}> = NoAllocFixedLenMessageOfPreallocatedSize::<44>::get_err_message();
    const MSG_44: ErrMessage<{ err_msg_buffer_size() }> = NoAllocFixedLenMessageOfPreallocatedSize::<44>::get_err_message();
    ...
    //const MSG_4096: ErrMessage<{ NoAllocFixedLenMessageOfPreallocatedSize::<0>::err_msg_buffer_size()}> = NoAllocFixedLenMessageOfPreallocatedSize::<4096>::get_err_message();
    const MSG_4096: ErrMessage<{ err_msg_buffer_size() }> = NoAllocFixedLenMessageOfPreallocatedSize::<4096>::get_err_message();
