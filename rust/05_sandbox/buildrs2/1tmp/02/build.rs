...
/// Uses ncurses headers and links with ncurses lib
fn gen_rs(
    source_c_file: &str,
    out_bin_file: &str,
    gen_rust_file: &str,
...
/// args with \0 in them, passed to Command::arg() or ::args()
...
impl MyCompilerCommand for Command {
    ...
    fn success_or_panic(&mut self) -> ExitStatus {
        ...
        //        self.success_or_else(|maybe_err,exit_status| {
